...
author = "Dítz"
print("Author: " + author)
script = "Automatic Send Message"
print("Script: " + script)
dc = "ditz.suka.uang"
print("Discord: " + dc)
print("===========================================")
print('PERINGATAN : Do No Use For Abuse')
print("===========================================\n")

time.sleep(1)

channel_id = input("ID channel: ")
waktu1 = int(input("Timer Delete Message(Second): "))
waktu2 = int(input("Timer Send Message(Second): "))
